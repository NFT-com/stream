...
const handlerMap: Record<string, { handler: any; repeat?: number; secondaryOptions?: any }> = {
  ...
  [QUEUE_TYPES.UPDATE_PROFILES_NFTS_STREAMS]: { handler: updateNFTsOwnershipForProfilesHandler, repeat: 15000 }, // 60000 * 10 = 10 minute syncs
  [QUEUE_TYPES.UPDATE_NON_PROFILES_NFTS_STREAMS]: { handler: updateNFTsForNonProfilesHandler, repeat: 15000 }, // 60000 * 10 = 10 minute syncs
  [QUEUE_TYPES.UPDATE_PROFILES_WALLET_NFTS_STREAMS]: { handler: pullNewNFTsHandler, repeat: 15000 }, // 60000 * 10 = 10 minute syncs
  ...
  [QUEUE_TYPES.GENERATE_COMPOSITE_IMAGE]: { handler: collectionBannerImageSync, repeat: 15000 },
